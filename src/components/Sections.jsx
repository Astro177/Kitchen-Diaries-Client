...
const Sections = () => {
  return (
    <div className="my-container">
      <p className="text-center text-color text-5xl font-semibold mb-4">
        Our Famous Dishes
      </p>
      <p className="text-center text-indigo-200 text-xl mb-12">Try them out to have the best experience</p>
