...
const Blogs = () => {
  return (
    <div className="my-container flex flex-col gap-6">
      ...
      >
        <div className="collapse-title text-xl font-medium text-color">
          Question #1: What is the differences between uncontrolled and
          controlled components?
        </div>
        <div className="collapse-content">
          <p>
            Ans: <br /> In React, controlled components refers to components
      ...
      >
        ...
        <div className="collapse-content">
          <p>
            Ans: <br /> You can validate react props using PropType in many
      ...
      >
        ...
        <div className="collapse-content">
          <p>
            Ans: <br /> Express is a minimal and flexible node. js web
      ...
      >
        ...
        <div className="collapse-content">
          <p>
            Ans: <br /> Custom React JS hooks offer reusability as when a custom
            hook is created, it can be reused easily, which makes the code
            cleaner and reduces the time to write the code. It also enhances the
